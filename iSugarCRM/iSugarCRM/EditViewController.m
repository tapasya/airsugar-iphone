...
-(void)saveRecord{
    ...
    [syncHandler uploadData:[NSArray arrayWithObject:[self._detailedData objectAtIndex:0]] forModule:self.metadata.objectClassIdentifier parent:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_detailedData != nil){
        ...
        evRowItem.value = [_dataSource objectForKey:dof.name];
    }
    else{
        evRowItem.value = @"";
    }
...
- (void)dateChanged:(id)sender
{
	...
	[(DataObject *)[_detailedData objectAtIndex:0] setObject:[dateFormatter stringFromDate:date] forFieldName:dof.name];
}
...
//                    }
                ...
                else
                {
                    ...
                    }else
                    {
                        ...
                        [_dataSource setObject:currentTextField.text forKey:dof.name];
